        ...
        static async Task Main(string[] args)
        {
            try
            {
                ...
                builder.UseSqlServer(
                    "Server=localhost,1433;Database=LearnWizard;User=sa;Password=Zamunda06;Encrypt=True;TrustServerCertificate=True;"
                    );

                LearnWizardAppDbContext dbContext = new LearnWizardAppDbContext(builder.Options);
                ...
                IdentityResult result = await identityContext.CreateUserAsync("admin", "admin", "admincho@abv.bg", 12, Role.Administrator);
